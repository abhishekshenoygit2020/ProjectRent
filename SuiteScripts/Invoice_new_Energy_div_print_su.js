function printInvoiceAction(request, response) {
    ...
    if (headerlogo) {
     ...
     template += " <tr> ";
     template += " <td> <p style =\"min-height:20px;\"><b>LPO No / <span class=\"arabicfont \" dir=\"rtl \">ال بي او</span> : </b> <br/> ${recor.otherrefnum} </p></td> ";
     template += " </tr> ";
     template += " <#else>";
     template += " <tr>";
     ...
     template += "  <table style=\"width:100%\">";
     template += "  <tr>";
     template += " <td> <p style =\"min-height:20px;\"><b>Pay Terms / <span class=\"arabicfont\" dir=\"rtl\">وقت الدفع المسبق </span> :</b>  <br/> ${record.custbody_payment_terms} </p></td>";
     template += " </tr>";
     ...
     template += "</style> ";
     template += "</head>";
     template += "    	 <body header=\"nlheader\" header-height=\"42%\" footer=\"nlfooter\" footer-height=\"10%\" size=\"A4\"> ";
 
 
     template += "   <#if record.subsidiary.internalid?string == '11'||record.subsidiary.internalid?string == '8'> ";
     // if (sub_id == "8") {
     //     template += "<br/>";
     // }
     if (sub_id == "8") {
         ...
         template += "        <td style=\"border-bottom: solid 1px #000000;width:15%\">Rental Start Date / <span class=\"arabicfont\" dir=\"rtl\">تاريخ بدء التأجير</span></td><td style=\"border-bottom: solid 1px #000000;border-right: solid 1px #000000;width:15%\">: ${record.startdate?string[\"d-MMM-yyyy\"]}</td> ";
         template += "     </tr> ";
         template += "      <tr> ";
             ...
             for (var i = 1; i <= lineCount; i++) {
                 ...
                 if (exclInPrint == "" || exclInPrint != "T") {
                     ...
                     template += "            <td colspan=\"8\" style=\"border-left:solid 1px #000000;\">" + replaceAndOper(descNextLine(removeNull(description))) + "<br/><span class=\"arabicfont\" dir = \"rtl\">" + arabic_desc + "</span></td> " +
                         "            <td align=\"right\" colspan=\"3\" style=\"border-left:solid 1px #000000;\">" + numberWithCommas(removeNull(rate)) + "</td> ";
                     ...
                     if (lineItem1 == 1906) {
                         ...
                         if (balanceDays) {
                             template += " ";
                             template += "            <td align=\"center\" colspan=\"2\" style=\"border-left:solid 1px #000000;\">" + balanceDays + " days &nbsp;</td> ";
                         }
                         template += " ";
     ...
     template += "      <tr><td style=\"width:336px;\" align=\"left\">Received By / <span class=\"arabicfont\" dir=\"rtl\">تم الاستلام من قبل</span> : _________________________________<br /><br />Received Date / <span class=\"arabicfont\" dir=\"rtl\">تاريخ الاستلام</span> : &nbsp;";
     template += "&nbsp;";
     template += "&nbsp;";
