...
//    nlapiLogExecution("DEBUG", "enddate",enddate);
    ...
    try {
        ...
        // filters.push(new nlobjSearchFilter('custrecord_rent_dfs_date',null, 'within','thismonth'));
            ...
            filters.push(new nlobjSearchFilter('custitem_rent_is_truck', 'custrecord_rent_asset_item', 'anyof', "1"));
        ...
        var form = nlapiCreateReportForm('Truck Standby Report - Month Wise');
