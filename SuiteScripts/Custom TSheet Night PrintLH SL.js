    ...
    if (request.getMethod() == 'GET') {
        ...
        if (isaditionalts == 'gen') {
            ...
            if (timesheetRes) {
                ...
                templateHeader += '<h4 style="width:100%;font-style:normal;text-decoration: underline;text-align:center;top:-60px;">TIME SHEET</h4>';

                templateHeader += '<table width="100%" style="font-size:12px;top:-60px;">';
                ...
                ///////////////////////////////////////////////////////////////////////////////////////////////////// everything brought in 1 table on 14-06-2023 rest of the code commented
                ...
                template += '<table style="width:100%;top:-60px;">';
                ...
                // template += '<td style="border-left:solid 1px #ccc;border-bottom:solid 1px #ccc;border-top:solid 1px #ccc;font-weight:bold;width:70px;font-size:12px;">Total Hrs</td>';
                ...
                //             template += '<table style="width:100%;top:-20px;">';
                //             template += '<tr style="border-bottom:solid 1px #ccc;line-height:100%;">';
                //             var monthNames = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
                //             stdate = stdate.getDate() + "-" + monthNames[stdate.getMonth()] + "-" + stdate.getFullYear();

                //             template += '<td style="border-left:solid 1px #ccc;width:110px;font-size:12px;">' + stdate + '</td>';
                //             template += '<td style="border-left:solid 1px #ccc;width:120px;font-size:12px;">' + manpowerRef + '</td>';
                ...
                //         }
                template += '<table style="width:100%;top:-60px;font-size:12px;border-left:solid 1px #ccc;border-bottom:solid 1px #ccc;border-right:solid 1px #ccc;">';
                template += '<tr><td  style="border-right: 1px solid #000;  "><b>Site / Job Details: &nbsp; </b> ' + removeNull(tsSite) + '</td> <td   ><b>Remarks ( if any )</b></td></tr>';

                // template += '<tr><td style="border-right: 1px solid #000;border-top:solid 1px #ccc;">&nbsp;</td><td style="border-top:solid 1px #ccc;">&nbsp;</td></tr>';
                // template += '<tr><td style="border-right: 1px solid #000;border-top: 1px solid #000;">&nbsp;</td><td style="border-top: 1px solid #000;">&nbsp;</td></tr>';
                template += '<tr><td  style="border-right: 1px solid #000;border-top: 1px solid #000;" align="center"><br /><br /><br /><b>Signature of Operations</b></td><td  align="center" style = "border-top: 1px solid #000;"><br /><br /><br /><b>Signature of customer</b></td></tr>';
                template += '</table>';
        ...
        // if (footerlogobottom) {
        //     footer += "<img style=\"width:96%; height:100%;top:70px;margin-left:-50px;\" height=\"100\%\" width=\"96\%\"  src = \"";
        //     var path = "https://7061228.app.netsuite.com" + nlapiLoadFile(footerlogobottom).getURL();
        //     footer += nlapiEscapeXML(path);
        //     footer += "\"></img>";
        // }
        // if (footerlogotop) {
        //     footer += "<img style=\"top:-10px;left:510px;margin-right:-40px;width:87%; height:100%;\" height=\"100\%\" width=\"87\%\"  src = \"";
        ...
        xml += '</macrolist>';
        xml += '</head>';
        xml += '<body style="font-family:sans-serif;" header="myheader" footer-height="4%" header-height="15%" footer="myfooter" padding="0.25in 0.25in 0.25in 0.25in" size="A4">';
        xml += template;
        xml += '</body>';
