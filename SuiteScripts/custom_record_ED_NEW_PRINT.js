function printInvoiceAction(request, response) {
    ...
    template += " </tr>";
    template += " <#if record.custbody_po_number_of_so?has_content>";
    template += " <tr> ";
    template += " <td> <p style =\"min-height:20px;\"><b>LPO No / <span class=\"arabicfont \" dir=\"rtl \">ال بي او</span> : </b>123456 </p></td> ";
    template += " </tr> ";
    template += " <#else>";
    template += " <tr>";
    template += " <td> <p style =\"min-height:20px;\"><b>LPO No / <span class=\"arabicfont\" dir=\"rtl\">ال بي او</span> : </b> abcdsed </p></td>";
    template += " </tr>";
    template += " </#if>\";";
    template += " </table>";
    template += "  </td>";
    ...
    // ----TESTING STARTS
        ...
        template += "  ";
        template += "    <table style=\"width:100%; padding-top:-20px\"> ";
            ...
            for (var i = 1; i <= lineCount; i++) {
                ...
                if (exclInPrint == "" || exclInPrint != "T") {
                    ...
                    template += "            <td colspan=\"8\" style=\"border-left:solid 1px #000000;\">" + replaceAndOper(descNextLine(removeNull(description))) + "<br/><span class=\"arabicfont\" dir = \"rtl\">" + arabic_desc + "</span></td> " +
                        "            <td align=\"right\" colspan=\"3\" style=\"border-left:solid 1px #000000;\">" + numberWithCommas(removeNull(robd_unit)) + "</td> ";
