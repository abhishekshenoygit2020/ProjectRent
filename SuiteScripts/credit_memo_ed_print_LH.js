function printEnergyDivisionLH(request, response) {
    ...
    template += "</style> ";
    template += "   </head> ";
    template += "   <body header=\"nlheader\" header-height=\"12%\" footer=\"nlfooter\" footer-height=\"5%\" padding=\"0.5in 0.3in 0.3in 0.4in\" size=\"A4\"> ";
