         ...
         try {
             ...
             if (context.request.method == 'GET') {
                 var form = serverWidget.createForm({
                     title: 'Truck Utilization Month wise Report'
                 });
                 ...
                 try {
                    ...
                    var asset=context.request.parameters.custpage_asset;
                     var timestamp = stamp();
                     redirect.toSuitelet({
                         scriptId: 'customscript_trucking_utilisation_report',
                         deploymentId: 'customdeploy_truck_utilization_report',
                         parameters: {
                             'custscript_truck_utilization_subsidiary': subsidiary,
                             'custscript_truck_utilization_strtdate': startdate,
                             'custscript_truck_utilization_enddate': enddate,
                              'custscript_truck_utilization_asset':asset
