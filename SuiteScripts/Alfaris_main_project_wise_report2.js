 ...
 */
 ...
 function(record, search, format, task, serverWidget, redirect, runtime, error, log) {
      ...
      * @Since 2015.2
      */
     function mainProjectRevenue(context) {
         // Code section : 1
         try {
             ...
             if (context.request.method == 'GET') {
                 var form = serverWidget.createForm({
                     title: 'Main Project  Wise Revenue Report'
                 });
                 ...
                 var mainproject = form.addField({
                    id: 'custpage_mainproject',
                    type: serverWidget.FieldType.SELECT,
                    label: 'Main Project',
                    source: 'customrecord_af_main_project'
                });
                ...
                // });
                 ...
                 try {
                    ...
                    var mainproject=context.request.parameters.custpage_mainproject;
                     var timestamp = stamp();
                     redirect.toSuitelet({
                         scriptId: 'customscript_mainprojectwisereport',
                         deploymentId: 'customdeploy_mainprojectwisereport',
                         parameters: {
                             ...
                             'custscript_equip_mainproject':mainproject,
