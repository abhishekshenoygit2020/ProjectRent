 ...
 */
 ...
 function(record, search, format, task, serverWidget, redirect, runtime, error, log) {
      ...
      * @Since 2015.2
      */
     function manpowerUtilizationRevenue(context) {
         // Code section : 1
         try {
             ...
             if (context.request.method == 'GET') {
                 var form = serverWidget.createForm({
                     title: 'Manpower Capacity Utilization Month wise Report'
                 });
                 ...
                 try {
                    ...
                    var asset=context.request.parameters.custpage_asset;
                     var timestamp = stamp();
                     redirect.toSuitelet({
                         scriptId: 'customscript_manpowerutilizationreport',
                         deploymentId: 'customdeploy_manpowerutilizationreport',
                         parameters: {
                             'custscript_manpower_utilization_subsidiary': subsidiary,
                             'custscript_manpower_utilization_strtdate': startdate,
                             'custscript_manpower_utilization_enddate': enddate,
                              'custscript_manpower_utilization_asset':asset
     ...
     return {
         onRequest: manpowerUtilizationRevenue
     };
