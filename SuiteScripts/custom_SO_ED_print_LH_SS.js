function printSalesOrderEnergyFormatAction(request, response) {
    ...
    template += "    </macrolist> " +
        ...
        "</style> " +
        "</head> " +
        " <#if record.subsidiary.internalid?string == '11'> " +
        "<body header=\"nlheader\" header-height=\"12%\" footer=\"nlfooter\" footer-height=\"6.5%\" padding=\"1.3in 0.5in 0.5in 0.5in\" size=\"Letter\"> " +
        "  <#else> " +
