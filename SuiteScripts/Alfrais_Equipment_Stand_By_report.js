         ...
         try {
             ...
             if (context.request.method == 'GET') {
                 var form = serverWidget.createForm({
                     title: 'Equipment StandBy Report- Month wise'
                 });
                ...
                //  });
                 ...
                 try {
                    ...
                    //  var enddate = context.request.parameters.custpage_ps_enddate;
                     ...
                     var timestamp = stamp();
                     redirect.toSuitelet({
                         scriptId: 'customscript_equipment_standby_report',
                         deploymentId: 'customdeploy_equ_stdby_rep',
                         parameters: {
                             'custscript_equipment_standby_subsidiary': subsidiary,
                            //  'custscript_equipment_standby_strtdate': startdate,
                            //  'custscript_equipment_standby_enddate': enddate,
