...
function eqiuquementRevenue(request, response) {
    var subsidiary = request.getParameter('custscript_manpower_standby_subsidiary');
    nlapiLogExecution("DEBUG", "subsidiary", subsidiary);
    //     var startdate = request.getParameter('custscript_manpower_standby_strtdate');
    //     nlapiLogExecution("DEBUG", "startdate",startdate);
    //    var enddate = request.getParameter('custscript_manpower_standby_enddate');
    ...
    try {
        ...
        filters.push(new nlobjSearchFilter('custitem_rent_item_type','custrecord_rent_asset_item', 'anyof', "2"));
        ...
        var form = nlapiCreateReportForm('Manpower Standby Report - Month Wise');
